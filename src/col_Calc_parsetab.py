...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','col.py',159),
  ('statement -> NAME PLUS EQUALS expression','statement',4,'p_statement_assignment_operation','col.py',163),
  ('statement -> NAME MINUS EQUALS expression','statement',4,'p_statement_assignment_operation','col.py',164),
  ('statement -> NAME TIMES EQUALS expression','statement',4,'p_statement_assignment_operation','col.py',165),
  ('statement -> NAME DIVIDE EQUALS expression','statement',4,'p_statement_assignment_operation','col.py',166),
  ('statement -> expression','statement',1,'p_statement_expr','col.py',178),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','col.py',186),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','col.py',187),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','col.py',188),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','col.py',189),
  ('expression -> expression EXP expression','expression',3,'p_expression_binop','col.py',190),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','col.py',205),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','col.py',209),
  ('expression -> NUMBER','expression',1,'p_expression_objects','col.py',214),
  ('expression -> HEX_COLOR','expression',1,'p_expression_objects','col.py',215),
  ('expression -> HSV_COLOR','expression',1,'p_expression_objects','col.py',216),
  ('expression -> RGB_COLOR','expression',1,'p_expression_objects','col.py',217),
  ('expression -> NAME','expression',1,'p_expression_name','col.py',222),
]
