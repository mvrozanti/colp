...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','colp.py',158),
  ('statement -> NAME PLUS EQUALS expression','statement',4,'p_statement_assignment_operation','colp.py',162),
  ('statement -> NAME MINUS EQUALS expression','statement',4,'p_statement_assignment_operation','colp.py',163),
  ('statement -> NAME TIMES EQUALS expression','statement',4,'p_statement_assignment_operation','colp.py',164),
  ('statement -> NAME DIVIDE EQUALS expression','statement',4,'p_statement_assignment_operation','colp.py',165),
  ('statement -> expression','statement',1,'p_statement_expr','colp.py',177),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','colp.py',185),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','colp.py',186),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','colp.py',187),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','colp.py',188),
  ('expression -> expression EXP expression','expression',3,'p_expression_binop','colp.py',189),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','colp.py',204),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','colp.py',208),
  ('expression -> NUMBER','expression',1,'p_expression_objects','colp.py',213),
  ('expression -> HEX_COLOR','expression',1,'p_expression_objects','colp.py',214),
  ('expression -> HSV_COLOR','expression',1,'p_expression_objects','colp.py',215),
  ('expression -> RGB_COLOR','expression',1,'p_expression_objects','colp.py',216),
  ('expression -> NAME','expression',1,'p_expression_name','colp.py',221),
]
