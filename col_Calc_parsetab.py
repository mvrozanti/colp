...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','col.py',158),
  ('statement -> NAME PLUS EQUALS expression','statement',4,'p_statement_assignment_operation','col.py',162),
  ('statement -> NAME MINUS EQUALS expression','statement',4,'p_statement_assignment_operation','col.py',163),
  ('statement -> NAME TIMES EQUALS expression','statement',4,'p_statement_assignment_operation','col.py',164),
  ('statement -> NAME DIVIDE EQUALS expression','statement',4,'p_statement_assignment_operation','col.py',165),
  ('statement -> expression','statement',1,'p_statement_expr','col.py',177),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','col.py',184),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','col.py',185),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','col.py',186),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','col.py',187),
  ('expression -> expression EXP expression','expression',3,'p_expression_binop','col.py',188),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','col.py',203),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','col.py',207),
  ('expression -> NUMBER','expression',1,'p_expression_objects','col.py',212),
  ('expression -> HEX_COLOR','expression',1,'p_expression_objects','col.py',213),
  ('expression -> HSV_COLOR','expression',1,'p_expression_objects','col.py',214),
  ('expression -> RGB_COLOR','expression',1,'p_expression_objects','col.py',215),
  ('expression -> NAME','expression',1,'p_expression_name','col.py',220),
]
